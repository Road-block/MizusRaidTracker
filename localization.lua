...
EQdkp-Plus Raid-Log-Import 0.5.6.x]=],
    ...
    EP_Onslaught_LootList = "Onslaught Loot List",
    ...
    ITP_IgnoreStacks = "Ignore stacks",
    ...
    TP_LogWhileSolo = "Track raids while being solo",
    TP_LogWhileGroup = "Track raids while being in a group",
...
MRT_L.GUI = { 
    ...
    TT_Boss_Rename = "Renames selected boss encounter.",
